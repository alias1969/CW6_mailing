...
class Client(models.Model):
    email = models.EmailField(verbose_name="email", unique=False, help_text="Введите email")
...
class Message(models.Model):
    topic = models.CharField(verbose_name="тема письма", max_length=30, help_text="Введите тему письма", **NULLABLE)
    body = models.TextField(verbose_name="тело письма", help_text="Введите содержимое письма", **NULLABLE)
    owner = models.ForeignKey(
        User,
        verbose_name="Пользователь",
        on_delete=models.CASCADE,
